            ...
            <ContainerLayout>
                ...
                <div className={`w-full flex flex-col items-start md:flex-row md:items-center justify-between md:py-[2.27%]  ${isMenuClicked ? '' : 'hidden md:flex'}`}>
                    ...
                    {/* Mobile Menu Bar */}
                     ...
                     <button onClick={()=>setIsMenuClicked(false)} className={`md:hidden w-full  ml-auto cursor-pointer mt-6 mr-6 overflow-hidden rounded-full  relative flex gap-4 items-center justify-end ${isMenuClicked ? '' : 'hidden'}`}>
